...
<div class="row">
     <div class="col-lg-12">
        <div class="intro-text">
            ...
            <div class="col-md-12">
                <span class="text-success">Masukkan No. Daftar Ulang dan Password yang diperoleh saat melakukan pendaftaran secara online.</span><br>
            </div>
             ...
             <span class="text-success"></span>
                <form action="" method="post">
                    <div class="form-group" style="padding-left:15px;padding-right:15px">
                        <input type="text" name="username" class="inp" placeholder="No. Daftar Ulang" required="true"  autofocus/>
                    </div>
