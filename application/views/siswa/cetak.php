...
<html>
  ...
  <body onload="window.print();">
    ...
    <br>
    <p align="center" style="margin-top:0px;"><u>(TEMPEL DI DEPAN MAP)</u></p>

    <table width="100%" border="0">
      <tr>
        <td width="200">NO. DAFTAR ULANG</td>
        <td width="1">:</td>
    ...
    <table width="100%" border="0" style="margin-left:5px;">
      ...
      <tr>
        <td>2.</td>
        <td>Cetak pernyataan Orangtua, Pernyataan Siswa, isian buku induk, dan isian dapodik</td>
        <td>:</td>
        <td>Masing-Masing 1 lembar</td>
      </tr>
      <tr>
        <td>3.</td>
        <td>Pas foto berwarna ukuran 3 x 4 (SERAGAM SEKOLAH)</td>
        <td>:</td>
        <td>2 lembar</td>
      </tr>
      ...
      <tr>
        <td>7.</td>
        <td>BUKTI DITERIMA (WEB : DOWNLOAD DI PPDB JABAR)</td>
        <td>:</td>
        <td>1 lembar</td>
      </tr>
      <br>
