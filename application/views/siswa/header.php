...
<body class="navbar-bottom <?php if($menu=='panel_siswa' AND $sub_menu=='biodata'){echo'sidebar-xs';} ?>">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="">PPDB -DAFTAR ULANG </a>
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="panel_siswa/cetak" target="_blank"><i class="icon-printer2"></i> <span>Cetak Bukti Daftar Ulang</span></a></li>
								<li><a href="panel_siswa/cetak_pernyataanortu" target="_blank"><i class="icon-printer2"></i> <span>Cetak Pernyataan Orang Tua</span></a></li>
								<li><a href="panel_siswa/cetak_pernyataansiswa" target="_blank"><i class="icon-printer2"></i> <span>Cetak Pernyataan Siswa</span></a></li>
								<li><a href="panel_siswa/cetak_bukuinduk" target="_blank"><i class="icon-printer2"></i> <span>Cetak Isian Buku Induk</span></a></li>
								<li><a href="panel_siswa/cetak_dapodik" target="_blank"><i class="icon-printer2"></i> <span>download Isian Dapodik</span></a></li>
