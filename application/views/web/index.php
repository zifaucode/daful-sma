...
<head>
    ...
    <title>PPDB SMAN 1 PARUNG</title>
		...
		<link rel="icon" type="image/png" href="assets/panel/images/logo_ok.png">
    <!-- Bootstrap Core CSS -->
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom bxshad">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top"><img src="img/logo.png" alt="Logo" width="30" style="position:absolute;margin-top:-10px;"> <span style="margin-left:35px;">PPDB- DAFTAR ULANG</span> </a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <div class="intro-text"><br>
                        <span class="name shad" style="font-size:35px">DAFTAR ULANG PPDB</span>
...
<!-- ----------------------------------------- -->
    <div class="cardmu">
        <center>
            <a href="pendaftaran" target="_blank"><img src="assets/images/cara.png" width="60px" height="60px"></a>
            <a href="pendaftaran" target="_blank"><p><font color="white">DAFTAR ULANG</font></p></a>
        </center>
    </div>
    <div class="cardmu">
        <center>
            <a href="logcs" target="_blank"><img src="assets/images/pendaftar.png" width="60px" height="60px"></a>
            <a href="logcs" target="_blank"><p><font color="white">LOGIN</font></p></a>
        </center>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="col-lg-12 text-center">
                                ...
                                <li>Melakukan Daftar ulang dengan cara Input data yang sesuai dan jelas adanya</li>
                                <li>jika telah input pendaftaran anda akan di arahkan ke halaman siswa </li>
                                
                                <li>download lalu Print Berkas yang terdapat pada halaman siswa sebagai bukti daftar ulang pada saat penyerahan berkas</li>
                                <li>Berkas yang Didownload dan di print yaitu : .</li>
                                
							    <li>Penyerahan berkas dilakukan sesuai jadwal yang telah diberikan pada pengumuman PPDB</li>
								</ol>
                            </div>
                        </div>
                    </div>
